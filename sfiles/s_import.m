function obj = s_import(fName, toPlot, obj0)
% create SpinW object from .cif and FullProf Studio .fst files
% 
% ### Syntax
% 
% `obj = s_import(fname, {toplot})`
% 
% ### Description
% 
% `obj = s_import(fname, {toplot})` can import Crystallographic
...
switch fExt
    ...
    case '.cif'
        ...
        elseif ~isempty(cif0.space_group_symop_operation_xyz)
            ...
            warning('s_import:WrongFormat','Missing symmetry operators, using P1')
            xyz0 = {'x,y,z'};
        end
        ...
        if size(name0,2) == nAtom
            ...
            error('s_import:WrongInput','The .cif file contains inconsistent information!')
        end
end
