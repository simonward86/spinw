function rotM = s_rotmat(rotAxis, rotAngle)
% generates 3D rotation matrix
% 
% ### Syntax
% 
% `R = s_rotmat(rotAxis,rotAngle)`
%
% ### Description
% 
% `R = s_rotmat(rotAxis,rotAngle)` produces the `R` rotation matrix that
