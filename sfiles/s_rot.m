function [V, rotM] = s_rot(rotAxis, rotAngle, V)
...
% 
% `[VR, R] = s_rot(rotAxis,rotAngle,V)`
%
% ### Description
% 
% `[~, R] = s_rot(rotAxis,rotAngle)` produces the `R` rotation matrix that
...
% ```
%
% `[VR, R] = s_rot(rotAxis,rotAngle,V)` also rotates the given `V`
