function [aList, SSext] = s_extendlattice(nExt, aList, SS)
% creates superlattice
% 
% ### Syntax
% 
% `aList = s_extendlattice(nExt,aList)`
% 
% `[aList, SSext] = s_extendlattice(nExt,aList,SS)`
%
% ### Description
% 
% `aList = s_extendlattice(nExt,aList)` creates a superlattice
% and calculates all atomic positions within the new superlattice by
% tiling it with the original cell.
%
% `[aList, SSext] = s_extendlattice(nExt,aList,SS)` also calculates the
