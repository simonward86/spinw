function [n, collinear] = s_nvect(S, epsilon)
% determines the best normal vector for the set of vectors
% 
% ### Syntax
% 
% `[n, collinear] = s_nvect(V)`
% 
% `[n, collinear] = s_nvect(V,epsilon)`
%
% ### Description
% 
% `[n, collinear] = s_nvect(V)` determines whether the given set of
...
%
%
% `[n, collinear] = s_nvect(V,epsilon)` also gives the upper limit of the
