function [polyRes, yout] = s_res(fid,polDeg,toplot,varargin)
% fits energy resolution with polynomial
% 
% ### Syntax
% 
% `p = s_res(source,poldeg)`
% 
% `p = s_res(source,poldeg,true)`
%
% ### Description
% 
% `p = s_res(fid,poldeg)` reads tabulated resolution data from the
...
% 
% `p = s_res(fid,poldeg,plot)` the polynomial fit will be shown in a
