function Qm = s_econtract(Q,varargin)
% converts (Q,E) values to Q values for diffraction instrument
% 
% ### Syntax
% 
% `Qm = s_econtract(Q,Name,Value)`
% 
% ### Description
% 
% `Qm = s_econtract(Q,Name,Value)` converts $(Q,E)$ values in the phase
...
meV2k = s_converter('meV',1,'k','neutron');
