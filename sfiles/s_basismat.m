function [M, asym] = s_basismat(symOp, r, tol)
% determines allowed tensor components in a given point group symmetry
% 
% ### Syntax
% 
% `[m, asym] = s_basismat(symop, r, tol)`
% 
% ### Description
% 
% `[m, asym] = s_basismat(symop, r, tol)` determines the allowed tensor
...
for ii = 1:nSym
    ...
    if ordR == 10
        error('s_basismat:WrongOp','Not a valid point group generator!');
    end
