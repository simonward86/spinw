...
%   `spin.unit.qmat` and applying it every time a reciprocal space
...
% ### See Also
% 
% [spin.genlattice] \| [spin.gencoupling] \| [spin.nosym]
%
...
if ~iscell(param.bvect) && size(param.bvect,1)~=3
    error('spin:newcell:WrongInput','Input has to be 1x3 cell or 3x3 matrix!');
end
...
atomList = s_extendlattice(nExt,atomList);
