...
% ### Description
% 
% `newObj = copy(obj)` clones a Spin object with all of its internal data.
% The `newObj` will be independent of the original `obj`. Since the [spin]
...
% 
% `newObj`
% : New [spin] object that contains all the data of `obj`.
% 
% ### See Also
% 
% [spin] \| [spin.struct]
