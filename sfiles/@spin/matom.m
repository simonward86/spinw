...
% ### Description
% 
% `mAtomList = matom(obj)` is the same as [spin.atom], but only lists the
% magnetic atoms, which have non-zero spin. Also this function stores the
% generated list in [spin.cache].
% 
% ### Output Arguments
% 
% `mAtomList`
...
%     $[3\times n_{magAtom}]$.
%   * `idx` Index in the symmetry inequivalent atom list [spin.unit_cell] 
