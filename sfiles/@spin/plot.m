...
%  
% The `spin.plot` function calls several high level plot routines to draw
...
%  
% The high level `spin.plot` function can send send parameters to any of
...
% 'cellColor'. In this case `spin.plot` will call the [swplot.plotcell]
...
% Plot types
fn_wrapper.plotName = {'atom' 'bond' 'ion' 'cell' 'base' 'chem'};
% list of plot functions
fn_wrapper.plotFun = {@swplot.plotatom @swplot.plotbond @swplot.plotion @swplot.plotcell @swplot.plotbase @swplot.plotchem};
