function signal = s_timeit(percent,varargin)
% timer and remaining time estimator
% 
% ### Syntax
% 
% `s_timeit(percent, {mode},{tid},{title})`
% 
% `signal = s_timeit(percent, {mode},{tid},{title})`
%
% ### Description
% 
% `s_timeit(percent, {mode},{fid},{title})` can display remaining time of
...
hPauseBtn = uicontrol(h, 'Style', 'pushbutton', 'String', 'Debug',...
    ...
    'Callback', 'dbstop in s_timeit.m at 23');
